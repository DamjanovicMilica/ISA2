...
(function () {
  ...
  angular.module('bioskopPoy').controller('Reserve1CinemaPageController', Reserve1CinemaPageController);

  Reserve1CinemaPageController.$inject = ['$scope', '$state', '$location', 'sessionService', 'guestService', '$stateParams', 'authenticationService'];

  function Reserve1CinemaPageController($scope, $state, $location, sessionService, guestService, $stateParams, authenticationService) {

    $scope.userInfo = sessionService.getUserInfo();

    guestService.getReserve1CinemaPageInfo($stateParams.cinemaId).then(function (response) {
