...
(function () {
  ...
  angular.module('bioskopPoy').controller('Reserve1TheatrePageController', Reserve1TheatrePageController);

  Reserve1TheatrePageController.$inject = ['$scope', '$state', '$location', 'sessionService', 'guestService', '$stateParams', 'authenticationService'];

  function Reserve1TheatrePageController($scope, $state, $location, sessionService, guestService, $stateParams, authenticationService) {

    $scope.userInfo = sessionService.getUserInfo();

    guestService.getReserve1TheatrePageInfo($stateParams.theatreId).then(function (response) {
